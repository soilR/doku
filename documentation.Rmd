...
🔍 Das folgende Kapitel bezieht sich auf [datanovia.com](https://www.datanovia.com/en/lessons/transform-data-to-normal-distribution-in-r/)
...
🔍 [https://towardsdatascience.com/](https://towardsdatascience.com/eveything-you-need-to-know-about-interpreting-correlations-2c485841c0b8)
...
🔍 [sthda.com](http://www.sthda.com/english/articles/31-principal-component-methods-in-r-practical-guide/112-pca-principal-component-analysis-essentials/)
...
Eine andere Möglichkeit ist im Terminal `git add --all` und dann die commit Nachricht mit `git commit -m "TEXT"` eingeben. Nicht vergessen danach mit `git push` oder über den grünen Push button im Git Fenster die Nachrichten auf github zu übertragen. Mit 
