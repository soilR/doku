...
packages <- c("tidyverse", "markdown", "knitr", "matrixStats", "patchwork", "lubridate", "plotly",  "naniar", "stlplus", "gt", "dygraphs", "htmltools", "zoo", "xts", "ggpmisc", "forcats", "RColorBrewer", "Kendall", "rstudioapi", "multcompView", "plyr", "bookdown", "janitor", "rstatix", "ggpubr", "moments", "tweetrmd", "ggthemes", "hexbin", "ggridges", "ggstream", "openair", "treemapify", "MBA", "akima", "ggridges")
...
Über die Möglichkeiten eine Basis-Abbildung aufzupimpen ist dieser [Blogbeitrag](https://www.cedricscherer.com/2019/05/17/the-evolution-of-a-ggplot-ep.-1/) und dieser [Blogbeitrag](https://www.cedricscherer.com/2019/08/05/a-ggplot2-tutorial-for-beautiful-plotting-in-r/) ans Herz gelegt. 
...
```{r}
p <- koog_day %>%
  filter(daily < as.POSIXct("2010-04-30")) %>%
  ggplot(aes(daily, st10)) +
  geom_line()
p
```
...
# Tagesbasis
p + scale_x_date(date_breaks = "1 day", date_labels = "%m-%d")
# Tagesbasis und jetzt auch lesbar
p + scale_x_date(date_breaks = "4 day", date_labels = "%m-%d")
# Tagesbasis und jetzt auch lesbar mit minor breaks auf Tagesbasis
p + scale_x_date(date_breaks = "4 day", date_labels = "%m-%d", minor_breaks = "1 day")
```
