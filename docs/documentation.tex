...
\date{Aktualisiert am: 2021-11-04 20:17:43}
...
\caption{Schema Datenanalyse}\label{fig:unnamed-chunk-3}
\end{figure}
...
\caption{Lage Standort Speicherkoog}\label{fig:unnamed-chunk-5}
\end{figure}
...
\caption{Messprogramm}\label{fig:unnamed-chunk-6}
\end{figure}
...
\emph{Der Beitrag wurde das letzte mal am 04 November, 2021 editiert}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_url}\NormalTok{(}\StringTok{"https://www.youtube.com/watch?v=NZxSA80lF1I\&t=53s"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\caption{R logo}\label{fig:unnamed-chunk-9}
\end{figure}
...
\caption{RStudio logo}\label{fig:unnamed-chunk-10}
\end{figure}
...
\caption{Tidyverse logo}\label{fig:unnamed-chunk-11}
\end{figure}
...
\caption{Benutzeroberfläche RStudio. Source: https://bookdown.org/ndphillips/YaRrr/}\label{fig:unnamed-chunk-14}
\end{figure}
...
\caption{Tidyverse logo}\label{fig:unnamed-chunk-16}
\end{figure}
...
\caption{caption}\label{fig:unnamed-chunk-17}
\end{figure}
...
\caption{Ein R package ist wie eine Glühbirne. Du musst sie mit install.packages() reindrehen, mit library() jedoch bei jeder neuen R Sitzung anschalten um sie zu nutzen. Source: https://bookdown.org/ndphillips/YaRrr/}\label{fig:unnamed-chunk-18}
\end{figure}
...
\caption{Dokumentation zur Funktion mean() um einen Mittelwert zu bilden}\label{fig:unnamed-chunk-20}
\end{figure}
...
\caption{Die Konsole mit der Kommandozeile von R. Source: https://bookdown.org/ndphillips/YaRrr/}\label{fig:unnamed-chunk-22}
\end{figure}
...
\caption{Code vom Skript an die Konsole senden. Source: https://bookdown.org/ndphillips/YaRrr/}\label{fig:unnamed-chunk-23}
\end{figure}
...
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(tidyverse)}
\NormalTok{df}\OtherTok{\textless{}{-}}\FunctionTok{read.csv}\NormalTok{(}\StringTok{"data/data\_year.csv"}\NormalTok{, }\AttributeTok{sep =} \StringTok{","}\NormalTok{)}
...
\NormalTok{df }\OtherTok{\textless{}{-}} \FunctionTok{read.csv}\NormalTok{(}\StringTok{"data/data\_year.csv"}\NormalTok{, }\AttributeTok{sep =} \StringTok{","}\NormalTok{)}
\CommentTok{\# Stelle den mittleren Grundwasserstand (wt; in cm) dar}
...
\caption{Illustration von Allison Horst}\label{fig:unnamed-chunk-34}
\end{figure}
...
\caption{Grundlegende Datenstruktur}\label{fig:unnamed-chunk-39}
\end{figure}
...
\caption{Illustration von Allison Horst}\label{fig:unnamed-chunk-41}
\end{figure}
...
\caption{Atomic vectors, source: https://adv-r.hadley.nz/vectors-chap.html}\label{fig:unnamed-chunk-42}
\end{figure}
...
\caption{S3 atomic vectors, source: https://adv-r.hadley.nz/vectors-chap.html}\label{fig:unnamed-chunk-51}
\end{figure}
...
\caption{Vergleich eines Skalars und eines Vektors}\label{fig:unnamed-chunk-54}
\end{figure}
...
\caption{Darstellung von Datenstrukturen}\label{fig:unnamed-chunk-69}
\end{figure}
...
\caption{Illustration von Allison Horst}\label{fig:unnamed-chunk-77}
\end{figure}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-81-1} \end{center}
...
\DocumentationTok{\#\# [1] 661.5772}
\CommentTok{\# SD}
\FunctionTok{sd}\NormalTok{(eh)}
\DocumentationTok{\#\# [1] 30.64064}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  num [1:100] 640 620 664 692 697 ...}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-102-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-102-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-102-3} \end{center}
...
\caption{Schema der Datenanalyse in R}\label{fig:unnamed-chunk-106}
\end{figure}
...
\caption{Konzept tidy data [R for Data Science](https://r4ds.had.co.nz/tidy-data.html)}\label{fig:unnamed-chunk-107}
\end{figure}
...
\caption{Tidyverse Logos}\label{fig:unnamed-chunk-108}
\end{figure}
...
\NormalTok{koog\_raw }\OtherTok{\textless{}{-}}\NormalTok{ readr}\SpecialCharTok{::}\FunctionTok{read\_csv2}\NormalTok{(}\StringTok{"data/data\_year.csv"}\NormalTok{)}
\NormalTok{koog\_raw}
\end{Highlighting}
\end{Shaded}

Ui, hier ist aber etwas schief gelaufen. Wir haben die Datei erfolgreich in unserer Arbeitsumgebung laden können aber 12 observations bei nur einer Variable?! Schaut euch den Datensatz \texttt{koog\_raw} mal genauer an, indem ihr auf das Symbol (rot umrandet) klickt:
...
\caption{Environment}\label{fig:unnamed-chunk-111}
\end{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{koog\_raw }\OtherTok{\textless{}{-}}\NormalTok{ readr}\SpecialCharTok{::}\FunctionTok{read\_delim}\NormalTok{(}\StringTok{"data/data\_year.csv"}\NormalTok{, }\AttributeTok{delim =} \StringTok{","}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\caption{Tab Taste}\label{fig:unnamed-chunk-113}
\end{figure}
...
\DocumentationTok{\#\# \# A tibble: 10 x 56}
\DocumentationTok{\#\#     year   time  st10  mp10  st20  mp20  st30  mp30  st60  mp60 st100 mp100}
\DocumentationTok{\#\#    \textless{}dbl\textgreater{}  \textless{}dbl\textgreater{} \textless{}dbl\textgreater{} \textless{}dbl\textgreater{} \textless{}dbl\textgreater{} \textless{}dbl\textgreater{} \textless{}dbl\textgreater{} \textless{}dbl\textgreater{} \textless{}dbl\textgreater{} \textless{}dbl\textgreater{} \textless{}dbl\textgreater{} \textless{}dbl\textgreater{}}
\DocumentationTok{\#\#  1  2010  3300. 11.5  1.42  11.4  1.09  11.3  1.20  11.1  0.692 10.8  0.563}
\DocumentationTok{\#\#  2  2011 10980.  9.40 0.942  9.35 0.695  9.34 0.582  9.06 0.471  9.21 0.405}
\DocumentationTok{\#\#  3  2012 19752.  9.92 0.752  9.86 0.508  9.89 0.471  9.25 0.346  9.63 0.209}
\DocumentationTok{\#\#  4  2013 28524.  9.31 0.681  9.37 0.457  9.34 0.481  8.57 0.452  9.09 0.339}
\DocumentationTok{\#\#  5  2014 37284. 10.7  1.08  10.7  0.697 10.7  0.972  9.64 0.644 10.4  0.480}
\DocumentationTok{\#\#  6  2015 46044.  9.77 0.646  9.83 0.221  9.82 0.223  8.97 0.128  9.83 0.112}
\DocumentationTok{\#\#  7  2016 54816.  9.47 1.26   9.94 1.48   9.58 1.27   9.11 1.01  10.1  0.586}
\DocumentationTok{\#\#  8  2017 63588   9.18 0.971  9.76 1.09   9.27 0.774  8.92 0.609  9.86 0.387}
\DocumentationTok{\#\#  9  2018 72348.  9.11 1.41   9.76 1.62   9.22 1.62   8.95 1.60   9.96 1.10 }
\DocumentationTok{\#\# 10  2019 81108.  8.95 1.06   9.58 1.24   9.13 1.12   9.04 0.911 10.1  0.618}
\DocumentationTok{\#\# \# ... with 44 more variables: st150 \textless{}dbl\textgreater{}, mp150 \textless{}dbl\textgreater{}, eh10a \textless{}dbl\textgreater{},}
...
\caption{Illustration von Allison Horst}\label{fig:unnamed-chunk-115}
\end{figure}
...
In der Spalte \texttt{time} stehen die Zeilennummern und unter \texttt{date} finden wir das Datum, allerdings als \texttt{character} hinterlegt. Beim Einlesen der Daten denkt R, dass es sich um Text handelt aber wir wissen es besser. Wir müssen R nun explizit mitteilen wie unser Zeitstempel \texttt{date} codiert ist, nämlich mit \texttt{\%Tag.\%Monat.\%Jahr\ \%Stunde:\%Minute}. In R wird ein Datum jedoch mit 2021-11-04 20:17:55 angegeben. Wir tun also folgendes:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{koog\_raw }\OtherTok{\textless{}{-}}\NormalTok{ readr}\SpecialCharTok{::}\FunctionTok{read\_delim}\NormalTok{(}\StringTok{"data/data\_koog\_example.csv"}\NormalTok{, }\AttributeTok{delim =} \StringTok{","}\NormalTok{)}
\FunctionTok{head}\NormalTok{(koog\_raw, }\AttributeTok{n =} \FunctionTok{c}\NormalTok{(}\DecValTok{5}\NormalTok{,}\DecValTok{3}\NormalTok{))}
\DocumentationTok{\#\# \# A tibble: 5 x 3}
\DocumentationTok{\#\#    ...1  time date               }
\DocumentationTok{\#\#   \textless{}dbl\textgreater{} \textless{}dbl\textgreater{} \textless{}dttm\textgreater{}             }
\DocumentationTok{\#\# 1     1     1 2010{-}04{-}01 00:00:00}
\DocumentationTok{\#\# 2     2     2 2010{-}04{-}01 01:00:00}
\DocumentationTok{\#\# 3     3     3 2010{-}04{-}01 02:00:00}
\DocumentationTok{\#\# 4     4     4 2010{-}04{-}01 03:00:00}
\DocumentationTok{\#\# 5     5     5 2010{-}04{-}01 04:00:00}
\end{Highlighting}
\end{Shaded}
...
\caption{Illustration von Allison Horst}\label{fig:unnamed-chunk-119}
\end{figure}
...
\FunctionTok{any\_na}\NormalTok{(koog\_day}\SpecialCharTok{$}\NormalTok{st10)}
...
\FunctionTok{are\_na}\NormalTok{(koog\_day}\SpecialCharTok{$}\NormalTok{st10) }\SpecialCharTok{\%\textgreater{}\%}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{n\_miss}\NormalTok{(koog\_day}\SpecialCharTok{$}\NormalTok{st10) }\SpecialCharTok{/} \FunctionTok{nrow}\NormalTok{(koog\_day) }\SpecialCharTok{*} \DecValTok{100}
\DocumentationTok{\#\# [1] 2.208122}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-126-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-127-1} \end{center}
...
\caption{Source from: https://xkcd.com/523/}\label{fig:unnamed-chunk-131}
\end{figure}
...
\caption{Source from: https://www.cedricscherer.com/}\label{fig:unnamed-chunk-132}
\end{figure}
...
\caption{Source from: http://bloggotype.blogspot.com/}\label{fig:unnamed-chunk-133}
\end{figure}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-134-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-135-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-136-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-137-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-137-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-138-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-139-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-140-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-141-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-142-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-142-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-143-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-143-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-144-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-145-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-146-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-147-1} \end{center}
...
\caption{Source from: https://xkcd.com/833/}\label{fig:unnamed-chunk-148}
\end{figure}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-149-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-151-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-151-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-151-3} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-152-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-153-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-153-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-154-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-155-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-155-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-156-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-157-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-158-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-158-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-159-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-159-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-159-3} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-159-4} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-160-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-161-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-162-1} \end{center}
...
\begin{Highlighting}[]
\NormalTok{p }\OtherTok{\textless{}{-}}\NormalTok{ koog\_day }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{filter}\NormalTok{(daily }\SpecialCharTok{\textless{}} \FunctionTok{as.POSIXct}\NormalTok{(}\StringTok{"2010{-}04{-}30"}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(daily, st10)) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{()}
\NormalTok{p}
\end{Highlighting}
...
\NormalTok{p }\SpecialCharTok{+} \FunctionTok{scale\_x\_date}\NormalTok{(}\AttributeTok{date\_breaks =} \StringTok{"1 week"}\NormalTok{, }\AttributeTok{date\_labels =} \StringTok{"\%W"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-176-2} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Tagesbasis}
\NormalTok{p }\SpecialCharTok{+} \FunctionTok{scale\_x\_date}\NormalTok{(}\AttributeTok{date\_breaks =} \StringTok{"1 day"}\NormalTok{, }\AttributeTok{date\_labels =} \StringTok{"\%m{-}\%d"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-176-3} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Tagesbasis und jetzt auch lesbar}
\NormalTok{p }\SpecialCharTok{+} \FunctionTok{scale\_x\_date}\NormalTok{(}\AttributeTok{date\_breaks =} \StringTok{"4 day"}\NormalTok{, }\AttributeTok{date\_labels =} \StringTok{"\%m{-}\%d"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-176-4} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Tagesbasis und jetzt auch lesbar mit minor breaks auf Tagesbasis}
\NormalTok{p }\SpecialCharTok{+} \FunctionTok{scale\_x\_date}\NormalTok{(}\AttributeTok{date\_breaks =} \StringTok{"4 day"}\NormalTok{, }\AttributeTok{date\_labels =} \StringTok{"\%m{-}\%d"}\NormalTok{, }\AttributeTok{minor\_breaks =} \StringTok{"1 day"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-176-5} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-177-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-178-2} \end{center}
...
\DocumentationTok{\#\#  1 10.8   8.28  9.74}
\DocumentationTok{\#\#  2 11.6   8.40  7.86}
\DocumentationTok{\#\#  3 10.5   9.32  8.22}
\DocumentationTok{\#\#  4 10.5   8.78  7.81}
\DocumentationTok{\#\#  5  9.54 10.1   7.59}
\DocumentationTok{\#\#  6 11.2   9.50  9.24}
\DocumentationTok{\#\#  7  8.77  8.09  7.20}
\DocumentationTok{\#\#  8  8.99  9.82  7.94}
\DocumentationTok{\#\#  9 10.3   8.57  8.24}
\DocumentationTok{\#\# 10  9.38 10.1   8.18}
...
\DocumentationTok{\#\#  1 st        10    10.8 }
\DocumentationTok{\#\#  2 st        20     8.28}
\DocumentationTok{\#\#  3 st        30     9.74}
\DocumentationTok{\#\#  4 st        10    11.6 }
\DocumentationTok{\#\#  5 st        20     8.40}
\DocumentationTok{\#\#  6 st        30     7.86}
\DocumentationTok{\#\#  7 st        10    10.5 }
\DocumentationTok{\#\#  8 st        20     9.32}
\DocumentationTok{\#\#  9 st        30     8.22}
\DocumentationTok{\#\# 10 st        10    10.5 }
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-180-3} \end{center}
...
\caption{Source from: https://clauswilke.com/dataviz/index.html}\label{fig:unnamed-chunk-181}
\end{figure}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-184-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-184-3} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-184-4} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-185-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-185-3} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-185-4} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-185-5} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-186-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-186-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-186-3} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-186-4} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-187-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-187-3} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-188-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-188-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-188-3} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-188-4} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-188-5} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-188-6} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-192-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-192-3} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-192-4} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-192-5} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-192-6} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-194-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-194-3} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-194-4} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-196-3} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-198-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-201-1} \end{center}
...
\caption{Source from: https://cran.r-project.org/web/packages/viridis/vignettes/intro-to-viridis.html}\label{fig:unnamed-chunk-202}
\end{figure}
...
\caption{Source from: https://cran.r-project.org/web/packages/earthtones/index.html}\label{fig:unnamed-chunk-203}
\end{figure}
...
\caption{Source from: https://github.com/AndreaCirilloAC/paletter}\label{fig:unnamed-chunk-204}
\end{figure}
...
\caption{Source from: https://projects.susielu.com/viz-palette}\label{fig:unnamed-chunk-205}
\end{figure}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-206-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-206-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-206-3} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-206-4} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-208-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-209-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-210-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-211-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-219-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-219-2} \end{center}
...
\caption{Schiefe einer Verteilung}\label{fig:unnamed-chunk-221}
\end{figure}
...
\caption{Illustration von Z. Jaadi: https://towardsdatascience.com}\label{fig:unnamed-chunk-225}
\end{figure}
...
\caption{Illustration von Z. Jaadi: https://towardsdatascience.com}\label{fig:unnamed-chunk-226}
\end{figure}
...
\caption{Illustration von Z. Jaadi: https://towardsdatascience.com}\label{fig:unnamed-chunk-228}
\end{figure}
...
\caption{Illustration von Z. Jaadi: https://towardsdatascience.com}\label{fig:unnamed-chunk-229}
\end{figure}
...
\caption{Illustration von Z. Jaadi: https://towardsdatascience.com}\label{fig:unnamed-chunk-231}
\end{figure}
...
\caption{Illustration von Z. Jaadi: https://towardsdatascience.com}\label{fig:unnamed-chunk-233}
\end{figure}
...
\caption{Illustration von C.Wilke: https://wilkelab.org/SDS375/}\label{fig:unnamed-chunk-234}
\end{figure}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-242-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-243-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-245-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-245-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-245-3} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-251-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-251-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-252-2} \end{center}
...
\caption{Datenstruktur in R}\label{fig:unnamed-chunk-255}
\end{figure}
...
\caption{Neues repository erstellen}\label{fig:unnamed-chunk-261}
\end{figure}
...
\caption{Kurze und prägnante Namen sind gut}\label{fig:unnamed-chunk-262}
\end{figure}
...
\caption{Kopieren der URL für das Verknüpfen des Projektes}\label{fig:unnamed-chunk-263}
\end{figure}
...
\caption{Kopieren der URL für das Verknüpfen des Projektes}\label{fig:unnamed-chunk-264}
\end{figure}
...
\caption{Commit von vielen Dateien}\label{fig:unnamed-chunk-265}
\end{figure}
...
\caption{Source from: https://github.com/rstudio/bookdown}\label{fig:unnamed-chunk-268}
\end{figure}
...
\caption{Einstellungen in welchem Ordner das Book veröffentlicht werden soll}\label{fig:unnamed-chunk-270}
\end{figure}
...
\caption{Einstellungen für GitHub Pages}\label{fig:unnamed-chunk-271}
\end{figure}
...
\caption{Shiny Prinzip, source: https://blog.efpsa.org/wp-content/uploads/2019/04/pic6.jpg}\label{fig:unnamed-chunk-277}
\end{figure}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-286-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-286-3} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-286-4} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-286-5} \end{center}
...
\caption{Lage Standort Speicherkoog}\label{fig:unnamed-chunk-287}
\end{figure}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-293-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-293-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-293-3} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-293-4} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-293-5} \end{center}
...
\caption{Henry Wang taken from: https://henrywang.nl/ggplot2-theme-elements-demonstration/}\label{fig:unnamed-chunk-294}
\end{figure}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-295-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-295-2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-296-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-297-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-298-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-299-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{documentation_files/figure-latex/unnamed-chunk-300-1} \end{center}
