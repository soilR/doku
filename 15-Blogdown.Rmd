...
* A great read is from the developer of blogdown (Allison Horst) [How
    ...
    blogdown](https://alison.rbind.io/post/new-year-new-blogdown/)
...
-   [See](https://bookdown.org/yihui/blogdown/domain-name.html)
...
-   Information are taken from
    ...
    -   [Allison Hill
        blog](https://alison.rbind.io/post/new-year-new-blogdown/)
